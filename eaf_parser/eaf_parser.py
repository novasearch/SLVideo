...
for tier in data_dict:
    ...
    for annotation in annotations:
        data_dict[tier]['annotations'].append({
            ...
            'start_time': int(time_slots_dict[annotation.attrib['TIME_SLOT_REF1']]['time_value']) - first_time_slot,
            'end_time': int(time_slots_dict[annotation.attrib['TIME_SLOT_REF2']]['time_value']) - first_time_slot,
...
#TODO - add the creation of embeddings        


# Get the data dict as json
def get_data_dict_json():
